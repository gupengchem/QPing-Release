...
const service = require("../../service/salesUtil/StoreService");
...
router.get('/export', function(req, res, next) {
    ...
    service.find(req.curUser, condition).then(data => {
        ...
        const buffer = xlsx.build([{name: "T_Store", data: _data}]);
        let fileName = `/T_Store_export${tool.dateFormatter(new Date(), 'yyyyMMdd')}.xlsx`;
