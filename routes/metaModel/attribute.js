...
const service = require("../../service/metaModel/AttributeService");
        ...
        if (err) {
            ...
            workSheetsFromFile[0].data.forEach(function (data,i) {
                if(i > 0 && data.length > 0){
                    ...
                    if(data[3]){_data['required'] = data[3];}
                    if(data[4]){_data['defaultValue'] = data[4];}
                    if(data[5]){_data['i18n'] = data[5];}
                    if(data[6]){_data['inputType'] = data[6];}
                    if(data[7]){_data['min'] = data[7];}
                    if(data[8]){_data['max'] = data[8];}
                    if(data[9]){_data['decimal'] = data[9];}
                    if(data[10]){_data['minLength'] = data[10];}
                    if(data[11]){_data['maxLength'] = data[11];}
                    if(data[12]){_data['options'] = data[12];}
                    if(data[13]){_data['params'] = data[13];}
                    if(data[14]){_data['tenant'] = data[14];}
                    if(data[15]){_data['state'] = data[15];}
                    if(data[16]){_data['createTime'] = data[16];}
                    if(data[17]){_data['creater'] = data[17];}
                    if(data[18]){_data['updateTime'] = data[18];}
                    if(data[19]){_data['updater'] = data[19];}
