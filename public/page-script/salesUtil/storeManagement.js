...
const page = {
    ...
    url : {
        list : '/salesUtil/store/list',
        remove : '/salesUtil/store/remove',
        save : '/salesUtil/store/save/{id}',
        detail : '/salesUtil/store/detail/{id}',
        importData : Dolphin.path.contextPath + '/salesUtil/store/import',
        exportData : '/salesUtil/store/export',
    },
