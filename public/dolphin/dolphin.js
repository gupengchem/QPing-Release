    ...
    LIST.prototype = {
        ...
        initTheader: function (tablePanel) {
            ...
            if (this.opts.checkbox) {
                ...
                if (this.opts.multiple) {
                    var cLabel = $('<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">');
                    // checkAll = $('<input type="checkbox" class="checkAll" />').appendTo(checkboxTh);
                    checkAll = $('<input type="checkbox" class="checkAll" />').appendTo(cLabel);
                    cLabel.append($('<span>'));
                    cLabel.appendTo(checkboxTh);
                }
            }
        ...
        addDataRow: function (data, rowIndex) {
            ...
            if (this.opts.checkbox) {
                ...
                var _inputLabel = $('<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">');
                _inputLabel.append(checkboxInput);
                _inputLabel.append('<span>');
                var checkboxCol = $('<td>').append(_inputLabel).appendTo(row);
            }
            if (this.opts.rowIndex) {
